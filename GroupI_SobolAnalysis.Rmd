...
plotSmean <- sense_mean_S %>% 
  ...
  geom_col() + 
  scale_fill_manual(values = c("goldenrod2", "indianred1","slateblue3", "darkolivegreen"), labels = c("Linear Growth Rate", "Carrying Capacity", "Exponential Growth Rate", "Canopy Closure Threshold")) +
  labs(fill = "Parameter", 
       x = "Sobol Sensitivity Value", 
       y = "Parameter",
       title = "Mean First Order Sensitivity Index") + 
  theme_minimal()
...
plotSmax <- sense_max_S %>% 
  ...
  labs(fill = "Parameter", 
       x = "Sobol Sensitivity Value", 
       y = "Parameter",
       title = "Maximum First Order Sensitivity Index") + 
  theme_minimal() 
...
plotTmean <- sense_mean_T %>% 
  ...
  labs(fill = "Parameter", 
       x = "Sobol Sensitivity Value", 
       y = "Parameter",
       title = "Mean Total Effect Sensitivity Index") + 
  theme_minimal()
...
plotTmax <- sense_max_T %>% 
  ...
  labs(fill = "Parameter", 
       x = "Sobol Sensitivity Value", 
       y = "Parameter",
       title = "Maximum Total Effect Sensitivity Index") + 
  theme_minimal() 
